...
import imgj, {img} from './images/image'
...
export default class componentName extends Component {
    ...
    GetPopular=()=>{
        ...
        return(
        <div className="main" style={{ backgroundImage:`url(https://image.tmdb.org/t/p/original/${this.state.isi.poster_path})`,backgroundPosition:'center',backgroundRepeat:'no-repeat',backgroundSize:'cover' }}>
